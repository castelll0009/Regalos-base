...
*/
///forear par las  tarjetas y swipers about contenido y orden
var tarjet_about = document.querySelectorAll(".about");
/*var tarjet_about_p = document.querySelectorAll(".p-about");*/
...
/*
  document.querySelector(".figure-container").addEventListener("click", (e)) =>
      if (e.target. === ){
